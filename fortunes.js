let fortunes = [
    ...
    "Now is a good time to start a creative project.",
    "You will enjoy good health, you will be surrounded by luxury.",
    "You are a person of strong sense of duty.",
    "A person with good friends is a wealthy person indeed.",
    "Dream lofty dreams, and as you dream, so shall you become.",
    "Great thoughts come from the heart.",
    "You love peace.",
    "Judge not according to the appearance.",
    "Money and resources might be limited, but your creativity is unlimited.",
    ...
    "Today, take a moment to do something just for yourself.",
    ...
    "Working hard, play hard, drink lots of water and get plenty of sleep.",
    ...
    "It takes more effort to complain about a task you don't want to do, than to just do it and be done.",
    ...
    "What is vice today may be virtue tomorow.",
    ...
    "Only deep action will free you.",
    ...
    "We all have extraordinary ability encoded within us, waiting to be released.",
    ...
    "A successful person is one who actively pursues a goal.",
    ...
    "Don't share your dreams with people who will tear them down.",
    ...
    "Take it easy.",
    "Live just for today, take it one day at a time.",
    ...
    "A cheerful message is on its way to you. Huzzah!",
    ...
    "Delete your social media accounts, they are a waste of time.",
    ...
    "The greatest preception is continual awareness.",
    ...
    "Explore something new or different today.",
    ...
    "Drink a liter of water a day for good health.",
    ...
    "Hidden opportunities surround you, be watchful and perceptive and find them!",
    "You have a great capability to break cookies - use it wisely!",
    "At times it is better to know when to exit than to enter.",
    ...
    "When you change the way you look at things, things tend to change.",
    ...
    "Take control of your life rather than letting things happen!",
    ...
    "Be good to you, you are the only one you've got.",
    ...
    "Be nice to animals, and they will shower you with love and affection.",
    "You never hesitate to tackle the most difficult problems.",
    "Hope is like food. You will starve without it.",
    "When fire and water go to war water always wins.",
    "An angry man opens his mouth and closes his mind.",
    "Make the system work for you, not the other way around.",
    "Anger clouds the mind's eye. Find the calm center to see clearly to the heart of any situation.",
    ...
    "Do today what others won't, so that tomorrow you may do what others can't.",
    ...
    "Love is at hand, be glad, and hold on to it!",
    ...
    "Stay true to your inner-self, you will benefit in many ways.",
    ...
    "Be respectful always, it costs you only your breath and may buy you as much as your life.",
    "A metaphor could save your life.",
    "Don't wait for your ship to come in, swim out to it.",
    "There are lessons to be learned by listening to others.",
    "Volition, Strength, Languages, Freedom and Power rests in you. Use them for your personal benefit!",
    ...
    "Worrying about some bad future event makes you endure it twice.",
    ...
    "Opportunities are like buses, there is always another one coming along soon.",
    "Love will lead the way.",
    "It is best to act with confidence, no matter how little right you have to it.",
    "Apply for that job, ask that person out, write that book, paint that picture, don't self-reject.",
    ...
    "You matter, you are important, you exist for a reason, even if that reason is just to exist!",
    ...
    "There is a time to be practical, that time is now.",
    "Bend the rod while it is still hot.",
    "Get knocked down 7 times, stand back up 8.",
    ...
    "Love Conquers all.",
    "When heaven wants to protect a man, does it send an army? No, it protects him with love.",
    "Stop nagging to your partner and take it day by day.",
    "The only person you really have control or influence over is yourself. Use this power for success and wealth.",
    ...
    "Never outshine the boss, he signs your paycheck.",
    ...
    "Wealth is a measurement of your service to others.",
    "You will soon witness a miracle.",
    "You create enthusiasm around you.",
    "There are big changes ahead for you. They will be good ones!",
    "You will have many happy days soon.",
    ...
    "The best prophet of the future is the past.",
    "Encourage your peers.",
    "Let your imagination wander. Let your creativity soar.",
    "Your pain is the breaking of the shell that encloses your understanding.",
    "Patience is key, a wait short or long will have its reward.",
    "Be assertive when decisive action is needed.",
    "It is best to take the right action, second best to take the wrong action, worst of all is to take no action at all.",
    "Hope brings about a better future.",
    ...
    "Even though it will often be difficult and complicated, you know you have what it takes to get it done.",
    "Believe that you can do the thing, and you will eventually succeed.",
    "There is always something you can do, no matter what the situation may be, that will move your life forward.",
    "Some men dream of fortunes, others dream of cookies.",
    "Things are never quite the way they seem.",
    "Your dream will come true when you least expect it.",
    ...
    "Stop searching forever, happiness is just next to you.",
    "You will plant the smallest seed and it will become the greatest and most mighty tree in the world.",
    "Find a new dream, and once you're sure you've found it, fight for it.",
    "See if you can learn anything from the children.",
    "It's Never Too Late For Good Things To Happen!",
    "A great pleasure in life is doing what others say you can't.",
    "Your life will prosper only if you acknowledge your faults and work to reduce them.",
    ...
    "Virtuous find joy while wrongdoers find grief in their actions.",
    ...
    "Gold never understands the pain of the furnance until after it has been purified by fire.",
    ...
    "If you have a serious doubt, then there is no doubt, you shouldn't do that thing.",
    "Do you believe? Endurance and persistence will be rewarded.",
    ...
    "Those who tell the truth are punished for exposing lies.",
    ...
    "You will kiss your crush ohhh-la-lahh!",
    ...
    "Take a concrete step towards your goal everyday, small steps add up to big journeys.",
    "Circumstance does not make the man; it reveals him to himself.",
    "Champions are not made in the ring, they are revealed there.",
    ...
    "Forgive yourself for your mistakes, there is not point in beating yourself up.",
    ...
    "Youth and entusiasm will always be overcome by old age and treachery.",
    ...
    "Seeking happiness will cause it to flee from you, attend to your responsibilities and soon happiness will come and light upon your shoulder.",
    ...
    "You can't date 'potential', it will only lead to frustration.",
    ...
    "A man is born to live and not to prepare to live.",
    ...
    "Time is the most valuable thing in the world, you don't know how much you have and you can never get more of it.",
    "A smile is your passport into the hearts of others.",
    "Your high-minded principles spell success.",
    "Hard work pays off in the future, laziness pays off now.",
    "Change can hurt, but it is a path that leads to something better.",
    "Enjoy the good luck a companion brings you.",
    "People are naturally attracted to you.",
    "A chance meeting opens new doors to success and friendship.",
    "You learn from your mistakes... You will learn a lot today.",
    "If you have something good in your life, don't let it go!",
    "What ever your goal is in life, embrace it visualize it, for it will be yours.",
    ...
    "The love of your life is stepping into your world this summer.",
...
//de-deduplicate by stuffing the phrases into the "key" of an object
for(var i = 0; i < fortunes.length; i++){
    uniques[fortunes[i]] = 0;
}
/*
//take the deduplicated list and assign FC symbols
let final = {};
